...
class ThreeByThreeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Gestures here
        let leftSwipeGesture = UISwipeGestureRecognizer(target: self, action:#selector(ThreeByThreeViewController.leftSwipedByUser(_:)))
    ...
    @objc func leftSwipedByUser(_ gesture: UISwipeGestureRecognizer){
        self.performSegue(withIdentifier: "moveToFive", sender: self)
    ...
    func createGrid(){
        ...
        for _ in 0..<3{
            for _ in 0..<3{
                ...
                if let image = UIImage(named: "water00"+String(labelnum)){
